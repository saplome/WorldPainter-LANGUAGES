...
- Оригинальный английский + 9 полных локализаций.
...
### Уникальные слои, доступные только в этом форке
...
- **:bangbang:НОВЫЕ СЛОИ МОГУТ ДОЛГО ЭКСПОРТИРОВАТЬСЯ В МИР Minecraft ИЗ-ЗА СЛОЖНОЙ СТРУКТУРЫ:bangbang:** 

### Интерфейс и иконки

- Две новые уникальные темы

*FlatLaf Cyan light*

<details>
<summary>Нажмите, чтобы развернуть изображение FlatLaf Cyan light</summary>
...
<details>
<summary>Нажмите, чтобы развернуть изображение FlatLaf One Dark</summary>
...
- Современный системный выбор файлов через окно проводника.
...
Она создаёт независимую копию, удаляет данные слоёв которые есть только в форке. Текущий файл и обычная команда сохранения не изменяются.
...
При первом запуске настройки оригинального **WorldPainter** могут быть скопированы в **WorldPainter Languages**; исходные настройки оригинала не изменяются.
...
- Inno Setup 6 для такого же Setup.exe;
