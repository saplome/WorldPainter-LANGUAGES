...
Этот документ описывает сборку WorldPainter Languages 2.27.0-L2.0.1 из исходников.
...
По умолчанию используется тег `v2.27.0-L2.0.1`, заголовок `WorldPainter Languages 2.27.0-L2.0.1` и файл `docs/RELEASE_NOTES_2.27.0-L2.0.1.md`. Повторный запуск обновляет существующий черновик и заменяет assets. Если релиз с этим тегом уже опубликован, скрипт останавливается и ничего не перезаписывает.
